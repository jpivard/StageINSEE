...
ui <- fluidPage(
    ...
    mainPanel(
        ...
        fluidRow( column( width = 6, h4("Evolution des émissions globales et comparaison avec l'Allemagne", align = 'left'), highchartOutput('courbe_emissions'),
                  column( width = 12, h4("Evolution des intensités carbone du PIB et comparaison avec l'Allemagne", align = 'right'), highchartOutput('courbe_intensite_carbone') )
