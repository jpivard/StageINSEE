...
ui <- fluidPage(
    ...
    mainPanel(
        ...
        fluidRow( column(width=12, h4("Emissions de CO2 par secteur en France depuis 1990",align='center'), plotOutput("Courbe_secteurs")),
...
server <- function(input, output) {
    ...
    #Barplot sur les émissions par secteur
