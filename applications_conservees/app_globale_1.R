...
ui <- navbarPage(
  ...
  titlePanel("Quelques données sur les enjeux de la transition écologique"),
  ...
  mainPanel(
    ...
    h1(paste0("Quelques données sur les émissions de CO2 et l'énergie en France")),
    ...
    fluidRow(column( width = 12,h4("Montants d'investissement public actuel", align = 'center'), plotlyOutput('plot_inv_secteurs_1')),
             fluidRow(column( width = 12,h4("Nouveaux objectifs d'investissement public", align = 'center'), plotlyOutput('plot_inv_secteurs_2')),
                      fluidRow(column( width = 12,h4("Investissements privés supplémentaires attendus", align = 'center'), plotlyOutput('plot_inv_secteurs_3'))
                      ),
                      
     h3(paste0("Investissements par financeurs")),
    fluidRow(column( width = 12,h4("Investissements historiques(2016-2018)", align = 'center'), plotlyOutput('financeurs_plot_1')),
