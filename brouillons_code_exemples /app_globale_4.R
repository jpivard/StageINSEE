...
dashboardBody(
    ...
    # fluid_design("energie_panel", "box1", "box2", "box3", "box4"),
    # fluid_design("investissements_panel", "box5", "box6", "box7", "box8"),
    # fluid_design("fin_verte_panel", "box_los1", "box_los2", "box_los3", NULL),
    ...
    fluidRow  (  
        ...
        div(  id = "CO2_panel", 
              ...
              em("Vision globale des émissions"),
               br(),
